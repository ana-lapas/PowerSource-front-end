    ...
    return (
        <>
            <Container>
                <NavBar />
                <div>
                    <Text>Transforme seu excesso de energia solar em lucro com PowerSource!</Text>
                    <Text>Compre e venda energia solar excedente de forma simples e eficiente.</Text>
